...
export default function Page(){
  return (<>
    <Section title="Designed for pleasure, engineered for safety" subtitle="Explore compatibility, compliance, and validation.">
    ...
    <Section title="Start a conversation" center>
      <div className="max-w-2xl mx-auto"><LeadForm vertical="Pleasure" /></div>
    </Section>
  </>);
}
