  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-display text-3xl font-bold text-primary-600">Edit Job Posting</h1>
          <p className="text-neutral-600">Update career opportunity details</p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* Actions */}
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-neutral-200">
            <h3 className="font-display text-lg font-bold text-primary-600 mb-4">Actions</h3>

            <div className="space-y-3">
              <Link
                href={`/careers/${job.slug}`}
                target="_blank"
                className="w-full text-center bg-accent-500 hover:bg-accent-600 text-white px-4 py-2 rounded-lg transition-colors block"
              >
                View Job Posting
              </Link>
              <div className="text-sm text-neutral-500 text-center">
                Preview how candidates will see this job
              </div>
            </div>
          </div>
        </div>
