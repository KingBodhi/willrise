...
export default function Page(){
  return (<>
    <Section title="Fall protection engineered for real-world suspension" subtitle="Integration with anchors, SRLs, absorbers; ANSI Z359/OSHA alignment.">
    ...
    <Section title="Start a conversation">
      <LeadForm vertical="Construction" />
    </Section>
  </>);
}
