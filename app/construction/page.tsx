...
export default function Page(){
  return (<>
    <Section title="Fall protection engineered for real-world suspension" subtitle="Explore compatibility, compliance, and validation.">
    ...
    <Section title="Start a conversation" center>
      <div className="max-w-2xl mx-auto"><LeadForm vertical="Construction" /></div>
    </Section>
  </>);
}
