...
export default function StandardsLandscapeforFallProtectionPage() {
  return (
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <nav className="text-sm text-neutral-600 mb-6">
              ...
              <span>Standards Landscape for Fall Protection</span>
            </nav>
            ...
            <p className="text-xl text-neutral-700 leading-relaxed">
              Navigating ANSI, OSHA, CSA, and EN standards
            </p>
          </div>
